...
export const POCKETS: Pocket[] = [
  { id: 0, x: PLAY_LEFT - 3, y: PLAY_TOP - 3, radius: 22.5 },
  { id: 1, x: TABLE_WIDTH / 2, y: PLAY_TOP - 6, radius: 21.5 },
  { id: 2, x: PLAY_RIGHT + 3, y: PLAY_TOP - 3, radius: 22.5 },
  { id: 3, x: PLAY_LEFT - 3, y: PLAY_BOTTOM + 3, radius: 22.5 },
  { id: 4, x: TABLE_WIDTH / 2, y: PLAY_BOTTOM + 6, radius: 21.5 },
  { id: 5, x: PLAY_RIGHT + 3, y: PLAY_BOTTOM + 3, radius: 22.5 },
];
